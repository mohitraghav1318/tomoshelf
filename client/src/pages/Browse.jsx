...
const CATEGORIES = [
  { id: 'fiction', label: 'Fiction', icon: Book, color: 'from-blue-500 to-cyan-500' },
  { id: 'mystery', label: 'Mystery', icon: Search, color: 'from-purple-500 to-indigo-500' },
  ...
  { id: 'sci-fi', label: 'Sci-Fi', icon: Rocket, color: 'from-indigo-600 to-blue-700' },
  ...
  { id: 'business', label: 'Business', icon: Briefcase, color: 'from-blue-700 to-indigo-800' },
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  className="group relative flex flex-col items-center justify-center p-8 rounded-2xl bg-gray-900/50 border border-white/5 hover:border-white/10 transition-all duration-300 overflow-hidden"
                >
          ...
          <>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h1 className="text-3xl font-bold text-white">
                  {selectedCategory.label} <span className="text-purple-500">Books</span>
                </h1>
              </div>
            ...
            {!loading && books.length === 0 && (
              <div className="text-center py-20">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-900 border border-white/5 mb-6">
